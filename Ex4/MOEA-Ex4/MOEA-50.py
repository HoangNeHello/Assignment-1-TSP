...
if __name__ == "__main__":
    l = logger.Analyzer(
        root="MOEA_results_50",
        algorithm_name="MOEA-50",
        algorithm_info="NSGA-II-lite; pop=50; runs=30; budget=100000; pc=0.9; pm=1/n; 2nd=min_size"
    )
    for fid in GRAPH_IDS:
        prob = get_problem(fid=fid, problem_class=ProblemClass.GRAPH)
        prob.attach_logger(l)
        run_moea_graph(prob, runs=30, budget=100_000, pop_size=50,
