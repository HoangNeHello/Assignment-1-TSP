...
def soea(func, runs: int = 30, budget: int | None = None,
         mu: int = 20, lam: int = 20, pc: float = 0.9, pm: float | None = None,
...
if __name__ == "__main__":
    ...
    l = logger.Analyzer(
        root="SOEA_results_20",                 # <- your preferred root (not 'data')
        algorithm_name="SOEA-20",
        algorithm_info="SOEA Ex3; mu=20, lam=20, pc=0.9, pm=1/n; runs=30; budget=10000"
    )
    ...
    for fid in GRAPH_IDS:
        ...
        soea(prob, runs=30, budget=100_000, mu=20, lam=20, pc=0.9, pm=None,
