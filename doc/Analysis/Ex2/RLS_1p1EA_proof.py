from code import RLS
from code import OnePlusOneEA
...
# run (1+1) EA
one_plus_one_ea = OnePlusOneEA(n, f3_harmonic_weights)
solution, fitness = one_plus_one_ea.run(max_iterations=10000)
