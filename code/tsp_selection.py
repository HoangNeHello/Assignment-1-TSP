...
def elitism(population_or_list, elite_fraction=0.2):
    inds = (population_or_list.individuals
            if hasattr(population_or_list, "individuals") else list(population_or_list))
