...
def soea(func, runs: int = 30, budget: int | None = None,
         mu: int = 10, lam: int = 10, pc: float = 0.9, pm: float | None = None,
...
if __name__ == "__main__":
    ...
    l = logger.Analyzer(
        root="SOEA_results_10",                 # updated to reflect μ=10
        algorithm_name=f"SOEA-10",   # <— distinct legend label
        algorithm_info="SOEA Ex3; mu=10, lam=10, pc=0.9, pm=1/n; runs=30; budget=10000"
    )
