...
UniformCrossoverGA(maxCov2100, 100000)
maxCov2101.attach_logger(log)
UniformCrossoverGA(maxCov2101, 100000)
maxCov2102.attach_logger(log)
UniformCrossoverGA(maxCov2102, 100000)
maxCov2103.attach_logger(log)
UniformCrossoverGA(maxCov2103, 100000)

maxInf2200.attach_logger(log)
UniformCrossoverGA(maxInf2200, 100000)
maxInf2201.attach_logger(log)
UniformCrossoverGA(maxInf2201, 100000)
maxInf2202.attach_logger(log)
UniformCrossoverGA(maxInf2202, 100000)
maxInf2203.attach_logger(log)
UniformCrossoverGA(maxInf2203, 100000)

pwc2300.attach_logger(log)
UniformCrossoverGA(pwc2300, 100000)
pwc2301.attach_logger(log)
UniformCrossoverGA(pwc2301, 100000)
pwc2302.attach_logger(log)
UniformCrossoverGA(pwc2302, 100000)
